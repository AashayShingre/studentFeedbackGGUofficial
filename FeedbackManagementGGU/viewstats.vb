...
Public Class viewstats
    ...
    Private Sub ComboBox1_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles ComboBox1.SelectionChangeCommitted
        ...
        Dim sqlQuery As String = "select sum(prop1_vg), sum(prop1_g), sum(prop1_s), sum(prop1_b),
                               ...
                               sum(prop10_vg), sum(prop10_g), sum(prop10_s), sum(prop10_b),
                               sum(prop11_vg), sum(prop11_g), sum(prop11_s), sum(prop11_b)
                         from feedbacks where teacher_id in (select teacher_id from teachers where course_id in (select course_id from courses where dept_id in (select dept_id from departments where school_id = " & school_id.ToString() & ")));"
    ...
    Private Sub ComboBox2_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles ComboBox2.SelectionChangeCommitted
        ...
        Dim sqlQuery As String = "select sum(prop1_vg), sum(prop1_g), sum(prop1_s), sum(prop1_b),
                               ...
                               sum(prop10_vg), sum(prop10_g), sum(prop10_s), sum(prop10_b),
                               sum(prop11_vg), sum(prop11_g), sum(prop11_s), sum(prop11_b)
                         from feedbacks where teacher_id in (select teacher_id from teachers where course_id in (select course_id from courses where dept_id = " & dept_id.ToString() & "));"
    ...
    Private Sub ComboBox3_SelectionChangeCommitted(sender As Object, e As EventArgs) Handles ComboBox3.SelectionChangeCommitted
        ...
        Dim sqlQuery As String = "select sum(prop1_vg), sum(prop1_g), sum(prop1_s), sum(prop1_b),
                               ...
                               sum(prop10_vg), sum(prop10_g), sum(prop10_s), sum(prop10_b),
                               sum(prop11_vg), sum(prop11_g), sum(prop11_s), sum(prop11_b)
                         from feedbacks where teacher_id in (select teacher_id from teachers where course_id = " & course_id.ToString() & ");"
